        ...
        <main className="mt-36 mx-auto max-w-7xl px-4 ">
          <div className="text-center">
            ...
            >
              ...
              <p className="font-serif">09 May 2022 | 13:00 WIB (GMT +7)</p>

              <div className="mt-5  max-w-md mx-auto sm:flex sm:justify-center justify-center md:mt-8 hover:cursor-pointer">
                <div className="rounded-md  flex justify-center">
                  <Link
                    href={`https://calendar.google.com/event?action=TEMPLATE&tmeid=Njh0dThpZHYxMThoZTQ2cGdiNDRnMGlpOWUgOHByZzZydmltcGU0Yzk0cDUxNzZxa3JsbXNAZw&tmsrc=8prg6rvimpe4c94p5176qkrlms%40group.calendar.google.com`}
                  >
                    <a
                      target="_blank"
